...
#### Configuring auth hooks, phone/SMS, and MFA

See the [Configure Auth Hooks](/docs/guides/self-hosting/docker-auth-hooks) guide for setup instructions covering auth hooks, SMS provider configuration, OTP settings, and multi-factor authentication.
